...
Patient portal Phases A–D are shipped. Full handoff:
...
- Patient auth for `/care/account` — **locked in decision 0005**; Phases A–D shipped (cookie, AccountWizard, live home, protocol gate, smoke)
